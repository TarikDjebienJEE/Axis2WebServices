...
public class LibrarianWebServiceTest {
	...
	public LibrarianWebServiceStub stub;

	@Before
	public void init() throws RemoteException {
		stub = new LibrarianWebServiceStub();
	}
	...
	public void sayHelloTest() throws RemoteException {
		...
		SayHelloResponse sayHelloResponse = stub.sayHello(sayHello);
	...
	public void addBookTest() throws RemoteException {
		...
		AddBookResponse addBookResponse = stub.addBook(addBook);
	...
	public void deleteBookTest() throws RemoteException {
		...
		DeleteBook deleteBook = new DeleteBook();
		deleteBook.setIsbn(addedBook.getIsbn());
		DeleteBookResponse deleteBookResponse = stub.deleteBook(deleteBook);
	...
	public void getBooksTest() throws RemoteException {
		...
		AddBookResponse addBookResponse1 = stub.addBook(addBook1);
		...
		AddBookResponse addBookResponse2 = stub.addBook(addBook2);
		...
		AddBookResponse addBookResponse3 = stub.addBook(addBook3);
		...
		GetBooksResponse getBooksResponse = stub.getBooks(getBooks);
	...
	public void getBookDescriptionTest() throws RemoteException {
		...
		GetBookDescriptionResponse bookDescriptionResponse = stub.getBookDescription(getBookDescription);
	...
	public void getUsersTest() throws RemoteException {
		...
		AddUserResponse addUserResponse1 = stub.addUser(addUser1);
		...
		AddUserResponse addUserResponse2 = stub.addUser(addUser2);
		...
		AddUserResponse addUserResponse3 = stub.addUser(addUser3);
		com.webservices.LibrarianWebServiceStub.User addedUser3 = addUserResponse3.get_return();

		GetUsers getUsers = new GetUsers();
		GetUsersResponse getUsersResponse = stub.getUsers(getUsers);
	...
	public void getUserDescriptionTest() throws RemoteException {
		...
		GetUserDescriptionResponse userDescriptionResponse = stub.getUserDescription(getUserDescription);
